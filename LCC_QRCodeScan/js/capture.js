(function() {
  ...
  function startup() {
    ...
    photoFliped = document.getElementById('photoFliped');
    startbutton = document.getElementById('startbutton');
    checkqr = document.getElementById('checkqr');
    ...
    checkqr.addEventListener('click', function(ev){
      checkqrcode();
      ev.preventDefault();
    }, false);
  ...
  function takepicture() {
    var context = canvas.getContext('2d');
    var contextF = canvas.getContext('2d');
    if (width && height) {
      canvas.width = width;
